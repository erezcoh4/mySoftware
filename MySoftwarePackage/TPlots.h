...
public:
    ...
    TH1F *  H1 ( TString, TCut, TString, int Nbins=10, double Xlow=0, double Xup=1
                , TString T="",  TString XT="", TString YT="", int c=1, int fc=38,int fStyle=1);
    ...
    void Draw1DVarAndCut (TString , int, float, float, TString, TString, TCut, bool DoLeg = false, TString cName = "");
